...
import static org.wikimedia.morelangs.keyboard.Keyboard.CODE_OUTPUT_TEXT;
import static org.wikimedia.morelangs.keyboard.Keyboard.CODE_SHIFT;
import static org.wikimedia.morelangs.keyboard.Keyboard.CODE_SWITCH_ALPHA_SYMBOL;
import static org.wikimedia.morelangs.keyboard.Keyboard.CODE_UNSPECIFIED;
...
public class Key {
    ...
    public Key(Resources res, Keyboard.Params params, Keyboard.Builder.Row row,
        ...
        final KeyStyles.KeyStyle style = params.mKeyStyles.getKeyStyle(keyAttr, parser);
    ...
    public static class Spacer extends Key {
        ...
        protected Spacer(Keyboard.Params params, int x, int y, int width, int height) {
            super(params, null, null, KeyboardIconsSet.ICON_UNDEFINED, CODE_UNSPECIFIED,
