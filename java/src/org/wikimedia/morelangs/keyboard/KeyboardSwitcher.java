...
import org.wikimedia.morelangs.keyboard.internal.KeyboardState;
import org.wikimedia.morelangs.latin.DebugSettings;
import org.wikimedia.morelangs.latin.ImfUtils;
...
public class KeyboardSwitcher implements KeyboardState.SwitchActions {
    ...
    public void startDoubleTapTimer() {
        ...
        if (keyboardView != null) {
            final PointerTracker.TimerProxy timer = keyboardView.getTimerProxy();
