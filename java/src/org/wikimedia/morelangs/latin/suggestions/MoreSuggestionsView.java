...
package org.wikimedia.morelangs.latin.suggestions;
...
import org.wikimedia.morelangs.keyboard.KeyDetector;
...
public class MoreSuggestionsView extends KeyboardView implements MoreKeysPanel {
    ...
    static final PointerTracker.TimerProxy EMPTY_TIMER_PROXY = new PointerTracker.TimerProxy.Adapter();
    ...
    private final PointerTracker.KeyEventHandler mModalPanelKeyEventHandler = new PointerTracker.KeyEventHandler() {
        @Override
        public KeyDetector getKeyDetector() {
