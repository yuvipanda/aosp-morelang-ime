...
import org.wikimedia.morelangs.latin.UserHistoryForgettingCurveUtils.ForgettingCurveParams;
...
public class ExpandableDictionary extends Dictionary {
    ...
    private boolean addWordAndShortcutsFromNode(final Node node, final char[] word, final int depth,
        ...
        if (finalFreq > 0 && !node.mShortcutOnly) {
            if (!callback.addWord(word, 0, depth + 1, finalFreq, mDicTypeId, UNIGRAM)) {
                return false;
            }
        }
