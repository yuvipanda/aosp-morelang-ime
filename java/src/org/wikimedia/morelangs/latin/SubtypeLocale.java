...
public class SubtypeLocale {
    ...
    public static String getSubtypeDisplayName(final InputMethodSubtype subtype, Resources res) {
        final String replacementString = (Build.VERSION.SDK_INT >= /* JELLY_BEAN */ 15
                ...
                ? subtype.getExtraValueOf(Constants.Subtype.ExtraValue.UNTRANSLATABLE_STRING_IN_SUBTYPE_NAME)
                : getSubtypeLocaleDisplayName(subtype.getLocale());
        final int nameResId = subtype.getNameResId();
        final LocaleUtils.RunInLocale<String> getSubtypeName = new LocaleUtils.RunInLocale<String>() {
            @Override
