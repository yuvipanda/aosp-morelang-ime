...
package org.wikimedia.morelangs.latin;
...
import org.wikimedia.morelangs.keyboard.ProximityInfo;
...
public class Suggest implements Dictionary.WordCallback {
    ...
    private ArrayList<SuggestedWords.SuggestedWordInfo> mSuggestions = new ArrayList<SuggestedWords.SuggestedWordInfo>();
    private ArrayList<SuggestedWords.SuggestedWordInfo> mBigramSuggestions = new ArrayList<SuggestedWords.SuggestedWordInfo>();
    ...
    protected void addBigramToSuggestions(SuggestedWords.SuggestedWordInfo bigram) {
    ...
    public SuggestedWords getBigramPredictions(CharSequence prevWordForBigram) {
        ...
        mSuggestions = new ArrayList<SuggestedWords.SuggestedWordInfo>(mPrefMaxSuggestions);

        // Treating USER_TYPED as UNIGRAM suggestion for logging now.
        LatinImeLogger.onAddSuggestedWord("", Suggest.DIC_USER_TYPED, Dictionary.UNIGRAM);
        mConsideredWord = "";

        mBigramSuggestions = new ArrayList<SuggestedWords.SuggestedWordInfo>(PREF_MAX_BIGRAMS);
        ...
        SuggestedWords.SuggestedWordInfo.removeDups(mSuggestions);
    ...
    public SuggestedWords getSuggestedWords(
            ...
            if (!TextUtils.isEmpty(prevWordForBigram)) {
                ...
                if (TextUtils.isEmpty(consideredWord)) {
                    ...
                    for (int i = 0; i < bigramSuggestionSize; i++) {
                        final SuggestedWords.SuggestedWordInfo bigramSuggestion = mBigramSuggestions.get(i);
        ...
        if (whitelistedWord != null) {
            if (mTrailingSingleQuotesCount > 0) {
                ...
                mSuggestions.add(0, new SuggestedWords.SuggestedWordInfo(
                        sb.toString(), SuggestedWords.SuggestedWordInfo.MAX_SCORE));
            } else {
                mSuggestions.add(0, new SuggestedWords.SuggestedWordInfo(
                        whitelistedWord, SuggestedWords.SuggestedWordInfo.MAX_SCORE));
            }
        }

        mSuggestions.add(0, new SuggestedWords.SuggestedWordInfo(typedWord, SuggestedWords.SuggestedWordInfo.MAX_SCORE));
        SuggestedWords.SuggestedWordInfo.removeDups(mSuggestions);
    ...
    private static ArrayList<SuggestedWords.SuggestedWordInfo> getSuggestionsInfoListWithDebugInfo(
        ...
        final ArrayList<SuggestedWords.SuggestedWordInfo> suggestionsList =
                new ArrayList<SuggestedWords.SuggestedWordInfo>(suggestionsSize);
    ...
    public boolean addWord(final char[] word, final int offset, final int length, int score,
        ...
        if (StringUtils.equalsIgnoreCase(mConsideredWord, word, offset, length)) {
            ...
            if (suggestions.size() > 0) {
                final SuggestedWords.SuggestedWordInfo currentHighestWord = suggestions.get(0);
        ...
        suggestions.add(pos, new SuggestedWords.SuggestedWordInfo(sb, score));
        if (suggestions.size() > prefMaxSuggestions) {
